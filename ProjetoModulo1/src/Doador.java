...
public class Doador implements Dados {
	...
	public void dispositivo() {
		...
		switch(quatidade) {
		case 1:
			System.out.println("\nOBRIGADO PELA SUA DOAÇÃO! VOCÊ ESTÁ AJUDANDO UMA PESSOA A CONTINUAR ESTUDANDO!");
			break;
		case 2:
			System.out.println("\nOBRIGADO PELA SUA DOAÇÃO! VOCÊ ESTÁ AJUDANDO DUAS PESSOAS A CONTINUAR ESTUDANDO!");
			break;
		default:
